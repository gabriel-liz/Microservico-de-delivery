...
public class DeliveryCheckpointService {
    ...
    public void place(UUID deliveryId){
        ...
        delivery.place();
        deliveryRepository.saveAndFlush(delivery); //Por termos assinados a classe com @Transactional, essa linha nem seria necessaria, mas mantive para ficar de forma explicita
    }
